...
Exec=/usr/bin/google-chrome-stable -no-default-browser-check -no-first-run --password-store=basic  --start-maximized --auto-open-devtools-for-tabs --load-extension="/home/chrome/git_file/tab-control-new"
OnlyShowIn=XFCE;
RunHook=0
StartupNotify=false
Terminal=false
