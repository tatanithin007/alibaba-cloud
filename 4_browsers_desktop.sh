...
Exec=/usr/bin/google-chrome-stable -no-default-browser-check -no-first-run --password-store=basic  --start-maximized --load-extension="/home/chrome/git_file/super-stable"
OnlyShowIn=XFCE;
RunHook=0
StartupNotify=false
Terminal=false
...
Name=chromium
Comment=chromium
Exec=/usr/bin/chromium-browser --no-default-browser-check -–no-first-run --password-store=basic --start-maximized --load-extension="/home/chrome/git_file/super-stable"
OnlyShowIn=XFCE;
RunHook=0
StartupNotify=false
Terminal=false
...
Name=google-chrome
Comment=Google Chrome
Exec=/usr/bin/google-chrome-unstable --no-default-browser-check -–no-first-run --password-store=basic  --start-maximized --load-extension="/home/chrome/git_file/super-stable"
OnlyShowIn=XFCE;
RunHook=0
StartupNotify=false
Terminal=false
...
Name=opera
Comment=opera
Exec=opera -–no-first-run --no-default-browser-check --password-store=basic --start-maximized --load-extension="/home/chrome/git_file/super-stable"
OnlyShowIn=XFCE;
RunHook=0
StartupNotify=false
Terminal=false
