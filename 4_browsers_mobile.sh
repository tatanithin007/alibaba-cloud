...
Exec=/usr/bin/google-chrome-stable -no-default-browser-check -no-first-run --password-store=basic  --start-maximized --auto-open-devtools-for-tabs --load-extension="/home/chrome/git_file/super-stable"
OnlyShowIn=XFCE;
RunHook=0
StartupNotify=false
Terminal=false
...
# chromiumon login
sudo mkdir -p /home/chrome/.config/autostart
sudo cat >  /home/chrome/.config/autostart/chromium.desktop << EOF
[Desktop Entry]
Encoding=UTF-8
Version=0.9.4
Type=Application
Name=chromium
Comment=chromium
Exec=/usr/bin/chromium-browser --no-default-browser-check -–no-first-run --password-store=basic --start-maximized --auto-open-devtools-for-tabs --load-extension="/home/chrome/git_file/super-stable"
OnlyShowIn=XFCE;
RunHook=0
StartupNotify=false
Terminal=false
...
#chrome unstable
sudo cat >  /home/chrome/.config/autostart/google-chrome-unstable.desktop << EOF
[Desktop Entry]
Encoding=UTF-8
Version=0.9.4
Type=Application
Name=google-chrome
Comment=Google Chrome
Exec=/usr/bin/google-chrome-unstable --no-default-browser-check -–no-first-run --password-store=basic  --start-maximized --auto-open-devtools-for-tabs --load-extension="/home/chrome/git_file/super-stable"
OnlyShowIn=XFCE;
RunHook=0
StartupNotify=false
Terminal=false
...
EOF
#OPERA unstable
sudo cat >  /home/chrome/.config/autostart/opera.desktop << EOF
[Desktop Entry]
Encoding=UTF-8
Version=0.9.4
Type=Application
Name=opera
Comment=opera
Exec=opera -–no-first-run --no-default-browser-check --password-store=basic --start-maximized --auto-open-devtools-for-tabs --load-extension="/home/chrome/git_file/super-stable"
OnlyShowIn=XFCE;
RunHook=0
StartupNotify=false
Terminal=false
